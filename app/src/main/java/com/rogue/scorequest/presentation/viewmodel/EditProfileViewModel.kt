...
class EditProfileViewModel(
    ...
    init {
        viewModelScope.launch {
            getProfile().collect { profile ->
                if (profile != null) {
                    originalAvatarPath = profile.avatarUri
                    _state.update {
    ...
    fun save() {
        viewModelScope.launch {
            ...
            if (originalAvatarPath != null && originalAvatarPath != current.avatarUri) {
